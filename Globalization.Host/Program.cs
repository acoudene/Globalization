...
#pragma warning restore CS0618
  ...
  builder.Services.AddScoped<IMyInformationRepository, MyInformationRepository>();
  ...
  builder.Services.AddControllers()
                  .ConfigureApplicationPartManager(apm => apm.ApplicationParts.Add(new AssemblyPart(typeof(MyInformationController).Assembly)))
                  ;
