...
`dotnet new vsa_generator -n MyGlobalization -o MyGlobalizationFolder -e MyEntity`
...
```
{
  ...
  "sourceName": "Globalization", // Will replace this string with the value provided via -n.
  "symbols": {
    "entityContentName": {
      "type": "parameter",
      "defaultValue": "MyEntity",
      "replaces": "MyInformation"
    },
    ...
    "entityFileName": {
      ...
      "fileRename": "MyInformation"
    },
    "globalizationContentName": {
      "type": "derived",
      "valueSource": "name",
      "valueTransform": "replace",
      "replaces": "Globalization"
    },
    "globalizationSolutionName": {
      "type": "derived",
      "valueSource": "name",
      "valueTransform": "replace",
